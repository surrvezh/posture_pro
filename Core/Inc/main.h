...
#define sckL_Pin GPIO_PIN_2
#define sckL_GPIO_Port GPIOC
#define sckR_Pin GPIO_PIN_3
#define sckR_GPIO_Port GPIOC
...
#define dtR_Pin GPIO_PIN_3
#define dtR_GPIO_Port GPIOA
#define dtL_Pin GPIO_PIN_4
#define dtL_GPIO_Port GPIOA
...
#define sckF_Pin GPIO_PIN_4
#define sckF_GPIO_Port GPIOC
#define sckB_Pin GPIO_PIN_5
#define sckB_GPIO_Port GPIOC
#define ARD_D3_Pin GPIO_PIN_0
#define ARD_D3_GPIO_Port GPIOB
#define dtF_Pin GPIO_PIN_1
#define dtF_GPIO_Port GPIOB
...
#define dtB_Pin GPIO_PIN_4
#define dtB_GPIO_Port GPIOB
